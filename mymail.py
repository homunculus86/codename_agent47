...
class MyEmailTools(Toolkit):
    """
    A toolkit for sending and reading emails on behalf of the user.
    """

    def __init__(self, receiver_email=None, sender_email=None, sender_name=None, sender_passkey=None):
        super().__init__(
            tools=[
                self.read_last_emails,
                self.send_email]
        )
        self.receiver_email = receiver_email or user_email
        self.sender_email = sender_email or user_email
        self.sender_name = sender_name or user_name
        self.sender_passkey = sender_passkey or password
